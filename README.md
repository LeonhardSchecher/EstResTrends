...
Dashboard - Contains the webapp version of the dashboard of our project. The code is in app.py and uses plotly dash framework.

Data_visualization - Contains test notebook file that we used to try out different plots on our database.

Link-to-data - Contains a Google Drive link to all data that we produced and used in our project.

Report-poster-other - Contains the poster image file and report as a PDF
