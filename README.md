...
3. Replace the DATA_PATH variable value with the location of the the data.json file in your computer and run the following command: "path_where_the dashboard_is_in_your_comuputer/"+Dashboard/app.py
4. Click on the link follwing "Dash is running on ..."
